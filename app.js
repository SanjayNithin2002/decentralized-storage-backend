...
app.use((req, res, next) => {
    const allowedOrigins = ['http://localhost:3000', 'https://decentralized-storage-frontend.onrender.com', 'postman://app', 'https://decentralized-storage-frontend.vercel.app'];
